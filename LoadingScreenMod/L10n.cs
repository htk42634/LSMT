...
namespace LoadingScreenModTest
{
    public static class L10n
    {
        ...
        static readonly string[] en =
        {
            ...
            @"Type", // TYPE = 115
            @"Status", // STATUS = 116
            @"Workshop id", // WORKSHOP_ID = 117
            @"Date", // DATE = 118
            @"Size", // SIZE = 119
            @"'Uses' count", // USES_COUNT = 120
            @"'Used by' count", // USED_BY_COUNT = 121
            @"Type and Status", // TYPE_AND_STATUS = 122
            @"Type and Size", // TYPE_AND_SIZE = 123
            @"Type and 'Used by' count", // TYPE_AND_USED_BY_COUNT = 124
            @"Status and 'Used by' count", // STATUS_AND_USED_BY_COUNT = 125
            @"'Used by' count and Size", // USED_BY_COUNT_AND_SIZE = 126
            @"Used in city", // USED_IN_CITY = 127
            @"Used in city and Size", // USED_IN_CITY_AND_SIZE = 128
            @"Workshop item", // WORKSHOP_ITEM = 129
            @"Used by", // USED_BY = 130
            @"Order by", // ORDER_BY = 131
            @"Find assets", // FIND_ASSETS = 132
            @"triangles", // TRIANGLES = 133
            @"vertices", // VERTICES = 134
            @"<long name>", // LONG_NAME = 135;
            @"Custom Assets", // CUSTOM_ASSETS = 136;
            @"Enabling and disabling assets", // ENABLING_AND_DISABLING = 137;
            @"Extremely large LOD mesh", // EXTREMELY_LARGE_LOD_MESH = 138;
            @" / sec" // PER_SECOND = 139;
        };
        ...
        static readonly string[] zh =
        {
            ...
            @"类型", // TYPE = 115
            @"状态", // STATUS = 116
            @"工坊id", // WORKSHOP_ID = 117
            @"日期", // DATE = 118
            @"大小", // SIZE = 119
            @"'使用' 总数", // USES_COUNT = 120
            @"'使用者' 总数", // USED_BY_COUNT = 121
            @"类型和状态", // TYPE_AND_STATUS = 122
            @"类型和大小", // TYPE_AND_SIZE = 123
            @"类型和'使用人'总数", // TYPE_AND_USED_BY_COUNT = 124
            @"状态和'使用人'总数", // STATUS_AND_USED_BY_COUNT = 125
            @"'使用者'总数和大小", // USED_BY_COUNT_AND_SIZE = 126
            @"用于城市", // USED_IN_CITY = 127
            @"用于城市和大小", // USED_IN_CITY_AND_SIZE = 128
            @"工坊资产", // WORKSHOP_ITEM = 129
            @"使用者", // USED_BY = 130
            @"排序", // ORDER_BY = 131
            @"找", // FIND_ASSETS = 132
            @"三角形", // TRIANGLES = 133
            @"顶点", // VERTICES = 134
            @"<长资产名称>", // LONG_NAME = 135;
            @"自定义资产", // CUSTOM_ASSETS = 136;
            @"启用和禁用资产", // ENABLING_AND_DISABLING = 137;
            @"非常大的LOD网格", // EXTREMELY_LARGE_LOD_MESH = 138;
            @" 资产/秒" // PER_SECOND = 139;
        };

        public static string Get(int key) => locale[key];
        public static string Get(string s, int key) => s + locale[key];
        public static string Get(string s1, int key, string s2) => s1 + locale[key] + s2;
        ...
        public static string Code => locale == zh ? "zh" : "en";

        public static void SetCurrent()
        {
            locale = LocaleManager.exists && LocaleManager.instance.language == "zh" ? zh : en;
        }
    }
}
